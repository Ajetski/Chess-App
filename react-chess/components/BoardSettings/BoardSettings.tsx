...
// import './BoardSettings.module.css'
...
const BoardSettings: FC = () => {
	const [boardTheme, setBoardTheme] = useState<string>(null);
	const [pieceTheme, setPieceTheme] = useState<string>(null);
	const [showModal, setShowModal] = useState(false);

	useEffect(() => {
		setBoardTheme(localStorage.getItem('board-theme') || 'blue2');
		setPieceTheme(localStorage.getItem('piece-theme') || 'merida');
	})
